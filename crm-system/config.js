...
const CONFIG = {
    // إعدادات Google Sheets (تم استخراجها ودمجها للتشغيل المباشر)
    SPREADSHEET_ID: '1N-E6G5-SULTAN-WASATA-SHEET-ID', // معرف الجدول الخاص بك
    
    // مفتاح الوصول الخاص (PRIVATE KEY) - تم تنسيقه للعمل في Vercel
